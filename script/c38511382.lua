...
function s.filter(c,tp)
	return c:IsFaceupEx() and c:IsSetCard(0x19e) and c:IsType(TYPE_MONSTER) and c:IsAbleToGraveAsCost()
...
function s.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc:IsSetCard(0x19e) and te:IsActiveType(TYPE_MONSTER) or tc:IsSetCard(0x19b)
