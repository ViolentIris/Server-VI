...
function c2116237.initial_effect(c)
	...
	e2:SetCountLimit(1,2116237+100)
...
function c2116237.spfilter(c,e,tp,sc)
	return c:IsSetCard(0x200) and c:IsAttack(3000) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
...
function c2116237.aclimit(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(2116237+100,RESET_EVENT+RESETS_STANDARD,0,1)
end
function c2116237.econ(e)
	return e:GetHandler():GetFlagEffect(2116237+100)~=0
end
