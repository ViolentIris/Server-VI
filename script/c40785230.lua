...
function c40785230.etcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c40785230.cfilter,1,nil,tp)
end
...
function c40785230.spfilter(c,e,tp)
	return c:IsSetCard(0x19a) and (c:IsLocation(LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE) or c:IsFaceup())
...
function c40785230.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SendtoHand(c,nil,REASON_EFFECT)>0 and c:IsLocation(LOCATION_HAND) then
		...
		local g=Duel.GetMatchingGroup(c40785230.spfilter,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED,0,nil,e,tp)
