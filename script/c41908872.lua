...
function c41908872.initial_effect(c)
	...
	e2:SetCountLimit(1,41908872+100)
...
function c41908872.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c41908872.cfilter1,tp,LOCATION_ONFIELD,0,1,nil)
		and Duel.IsExistingMatchingCard(c41908872.cfilter2,tp,LOCATION_MZONE,0,1,nil)
end
...
function c41908872.thcon2(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c41908872.thfilter2,1,nil,tp) and e:GetHandler():IsFaceup()
end
